...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		{
			$query1 = "insert into citizen(username,email,Phone,VID,pass) values ('$username' , '$email' , '$Phone' , '$VID' , '$pass')" ;
            $query2= "insert into fine(username,VID) values ('$username' , '$VID')" ;
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
                    <br><br><br><br>
					<img src="images/citizen.svg" alt="IMG">
				</div>
                <form method="post"> 
                    <div class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid phone number required">
                            <input class="input100" type="text" maxlength="10" name="Phone" placeholder="Phone" required>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-envelope" aria-hidden="true"></i>
                            </span>
                        </div>      
                        <div class="wrap-input100 validate-input" data-validate = "Valid Vehicle ID is required: KL-XX-AX-5050">
                            <input class="input100" type="text" name="VID" placeholder="Vehicle ID" required>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-envelope" aria-hidden="true"></i>
                            </span>
                        ...
                        <div class="text-center p-t-12">
                            ...
                            <a class="txt2" href="osignup.php">
                                Officer Signup
                            </a>
                        </div>
                        <div class="text-center p-t-12">
                            <a class="txt2" href="clogin.php">
