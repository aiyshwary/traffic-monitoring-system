            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="ohome.php#top" class="active">Home</a></li>
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Road ID</th>
									<th class="cell100 column3">Station Name</th>
									<th class="cell100 column4">Road Name</th>
								</tr>
							</thead>
						</table>
					</div>
									...
									while($row = mysqli_fetch_assoc($res))
									{
										...
										?>
											<tr class="row100 body">
												<td class="cell100 column1"><?php echo $rid; ?>.</td> 
												<td class="cell100 column3"><?php echo $station; ?></td>
												<td class="cell100 column4	"><?php echo $rname; ?></td>                  
											</tr>
										<?php
									}
								}
